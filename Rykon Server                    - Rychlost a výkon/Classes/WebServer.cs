...
namespace RykonServer
{
    class WebServer
    {
        ...
        public static string Control_auth_tokenname  ="Cnt_Auth_Tok";
        public static string masterMiddleReplacor = "$&mastermiddle&$";// { get; set; }
        public static string masterPageAfter ="";//{ get; set; }
        public static string masterPagePre = "";//{ get; set; }
